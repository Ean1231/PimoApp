...
import 'inspection_list_model.dart';
export 'inspection_list_model.dart';
...
class InspectionListWidget extends StatefulWidget {
  ...
  @override
  _InspectionListWidgetState createState() => _InspectionListWidgetState();
}

class _InspectionListWidgetState extends State<InspectionListWidget> {
  late InspectionListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InspectionListModel());
