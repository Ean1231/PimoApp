...
class _HomeWidgetState extends State<HomeWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultoh9 = await PimoApiGroup.getUserCall.call(
        email: FFAppState().email,
      );
      if ((_model.apiResultoh9?.succeeded ?? true)) {
        setState(() {
          FFAppState().DisplayName = getJsonField(
            (_model.apiResultoh9?.jsonBody ?? ''),
            r'''$..displayName''',
          ).toString().toString();
