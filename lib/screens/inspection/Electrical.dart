...
class Electrical extends StatefulWidget {
  ...
  Electrical({required this.manageID ,required this.email, required this.displayName, this.currentPosition, this.currentAddress,required this.currentDate, required this. currentSuburb, required this. currentPostalCode, required this.currentMunicipality,});  
